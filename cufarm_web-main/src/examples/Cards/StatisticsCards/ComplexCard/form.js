    ...
    <Container>
      ...
      {relayAutoState.length >= 0 && (
        <>
          {relayAutoState.map((field, index) => (
            ...
            <Col xs="4">
              <div className="add-player-div">
                ...
                <MDBox display="flex" alignItems="center" mt={{ xs: 1, sm: 0 }} ml={{ xs: -0.1, sm: 0 }}>
                ...
                <MDTypography mt={1} display="block" variant="button" >
                  ให้เปิดเมื่อ
                </MDTypography>

                <FormControl sx={{ ml: -0.1, minWidth: 310 }}>
                  <Select
                    sx={{ ml: -0.1, minWidth: 310, minHeight: 40, mb: 1 }}
                ...
                <TextField sx={{ ml: -0.1, minWidth: 310, mb: 1, minHeight: 40 }} id="outlined-basic" name="criteriaValue" defalutValue="กรุณาใส่ค่า sensor" value={field.criteriaValue} variant="outlined" onChange={(value) => handleInputChange(index, value)} />
          ...
          <MDButton mt={2} m={3} variant="gradient" fullWidth color="info" onClick={() => handleAddRelayAuto()}>
            เพิ่มการตั้งค่าใหม่
          </MDButton>
        </>
